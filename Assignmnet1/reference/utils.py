...
def load_data():
    ...
    #training set
    x_train = read_file("../data/question_2_1/x_train.csv")
    train_set_x = np.array(x_train)
    train_set_x = train_set_x.astype(float)
    train_set_x = train_set_x.reshape(train_set_x.shape[0], -1).T

    y_train = read_file("../data/question_2_1/y_train.csv")
    ...
    #test set
    x_test = read_file("../data/question_2_1/x_test.csv")
    test_set_x = np.array(x_test)
    test_set_x = test_set_x.astype(float)
    test_set_x = test_set_x.reshape(test_set_x.shape[0], -1).T

    y_test = read_file("../data/question_2_1/y_test.csv")
